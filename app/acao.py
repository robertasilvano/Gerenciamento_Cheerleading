...
def escolher_colunas(tabela, flag):
...
def acao_select(tabela):
    ...
    # seleciona todas colunas da tabela escolhida, e cria um menu para o usuário selecionar quais colunas quer realizar a ação
    col_selecionadas_query, col_selecionadas_vetor = escolher_colunas(tabela, 'select')
...
def acao_insert(tabela):
    # seleciona todas colunas da tabela escolhida, e cria um menu para o usuário selecionar quais colunas quer realizar a ação
    col_selecionadas_query, col_selecionadas_vetor = escolher_colunas(tabela, 'insert')
    ...
    #####tem que ver como funciona os inserts em tabelas do meio
